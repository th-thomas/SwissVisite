...
INSERT INTO dbo.famillemedic (FAM_CODE, FAM_LIBELLE) VALUES
...
CREATE TABLE dbo.medicament (
  ...
  MED_PRIXECHANTILLON DECIMAL DEFAULT NULL,
  FAM_CODE VARCHAR(255) NOT NULL,
...
INSERT INTO dbo.medicament (MED_DEPOTLEGAL, MED_NOMCOMMERCIAL, MED_COMPOSITION, MED_EFFETS, MED_CONTREINDIC, MED_PRIXECHANTILLON, FAM_CODE) VALUES
...
CREATE TABLE dbo.typepraticien (
...
INSERT INTO dbo.typepraticien (TYP_CODE, TYP_LIBELLE, TYP_LIEU) VALUES
...
CREATE TABLE dbo.praticien (
  ...
  PRA_CP VARCHAR(255) DEFAULT NULL,
  PRA_VILLE VARCHAR(255) DEFAULT NULL,
  PRA_COEFNOTORIETE INT DEFAULT NULL,
  TYP_CODE VARCHAR(255) NOT NULL,
  PRIMARY KEY (PRA_NUM),
...
INSERT INTO dbo.praticien (PRA_NUM, PRA_NOM, PRA_PRENOM, PRA_ADRESSE, PRA_CP, PRA_VILLE, PRA_COEFNOTORIETE, TYP_CODE) VALUES
...
CREATE TABLE dbo.visiteur (
  ...
  VIS_CP VARCHAR(255) DEFAULT NULL,
...
INSERT INTO dbo.visiteur (VIS_MATRICULE, VIS_NOM, VIS_PRENOM, VIS_ADRESSE, VIS_CP, VIS_VILLE, VIS_DATEEMBAUCHE) VALUES
('a131', 'Villechalane', 'Louis', '8 cours Lafontaine', '29000', 'BREST', '19921211'),
('a17', 'Andre', 'David', '1 r Aimon de Chissée', '38100', 'GRENOBLE', '19910826'),
('a55', 'Bedos', 'Christian', '1 r Bénédictins', '65000', 'TARBES', '19870717'),
('a93', 'Tusseau', 'Louis', '22 r Renou', '86000', 'POITIERS', '19990102'),
('b13', 'Bentot', 'Pascal', '11 av 6 Juin', '67000', 'STRASBOURG', '19960311'),
('b16', 'Bioret', 'Luc', '1 r Linne', '35000', 'RENNES', '19970321'),
('b19', 'Bunisset', 'Francis', '10 r Nicolas Chorier', '85000', 'LA ROCHE SUR YON', '19990131'),
('b25', 'Bunisset', 'Denise', '1 r Lionne', '49100', 'ANGERS', '19940703'),
('b28', 'Cacheux', 'Bernard', '114 r Authie', '34000', 'MONTPELLIER', '20000802'),
('b34', 'Cadic', 'Eric', '123 r Caponière', '41000', 'BLOIS', '19931206'),
('b4', 'Charoze', 'Catherine', '100 pl Géants', '33000', 'BORDEAUX', '19970925'),
('b50', 'Clepkens', 'Christophe', '12 r Fédérico Garcia Lorca', '13000', 'MARSEILLE', '19980118'),
('b59', 'Cottin', 'Vincenne', '36 sq Capucins', '5000', 'GAP', '19951021'),
('c14', 'Daburon', 'François', '13 r Champs Elysées', '6000', 'NICE', '19890201'),
('c3', 'De', 'Philippe', '13 r Charles Peguy', '10000', 'TROYES', '19920505'),
('c54', 'Debelle', 'Michel', '181 r Caponière', '88000', 'EPINAL', '19910409'),
('d13', 'Debelle', 'Jeanne', '134 r Stalingrad', '44000', 'NANTES', '19911205'),
('d51', 'Debroise', 'Michel', '2 av 6 Juin', '70000', 'VESOUL', '19971118'),
('e22', 'Desmarquest', 'Nathalie', '14 r Fédérico Garcia Lorca', '54000', 'NANCY', '19890324'),
('e24', 'Desnost', 'Pierre', '16 r Barral de Montferrat', '55000', 'VERDUN', '19930517'),
('e39', 'Dudouit', 'Frédéric', '18 quai Xavier Jouvin', '75000', 'PARIS', '19880426'),
('e49', 'Duncombe', 'Claude', '19 av Alsace Lorraine', '9000', 'FOIX', '19960219'),
('e5', 'Enault-Pascreau', 'Céline', '25B r Stalingrad', '40000', 'MONT DE MARSAN', '19901127'),
('e52', 'Eynde', 'Valérie', '3 r Henri Moissan', '76000', 'ROUEN', '19911031'),
('f21', 'Finck', 'Jacques', 'rte Montreuil Bellay', '74000', 'ANNECY', '19930608'),
('f39', 'Frémont', 'Fernande', '4 r Jean Giono', '69000', 'LYON', '19970215'),
('f4', 'Gest', 'Alain', '30 r Authie', '46000', 'FIGEAC', '19940503'),
('g19', 'Gheysen', 'Galassus', '32 bd Mar Foch', '75000', 'PARIS', '19960118'),
('g30', 'Girard', 'Yvon', '31 av 6 Juin', '80000', 'AMIENS', '19990327'),
('g53', 'Gombert', 'Luc', '32 r Emile Gueymard', '56000', 'VANNES', '19851002'),
('g7', 'Guindon', 'Caroline', '40 r Mar Montgomery', '87000', 'LIMOGES', '19960113'),
('h13', 'Guindon', 'François', '44 r Picotière', '19000', 'TULLE', '19930508'),
('h30', 'Igigabel', 'Guy', '33 gal Arlequin', '94000', 'CRETEIL', '19980426'),
('h35', 'Jourdren', 'Pierre', '34 av Jean Perrot', '15000', 'AURRILLAC', '19930826'),
('h40', 'Juttard', 'Pierre-Raoul', '34 cours Jean Jaurès', '8000', 'SEDAN', '19921101'),
('j45', 'Labouré-Morel', 'Saout', '38 cours Berriat', '52000', 'CHAUMONT', '19980225'),
('j50', 'Landré', 'Philippe', '4 av Gén Laperrine', '59000', 'LILLE', '19921216'),
('j8', 'Langeard', 'Hugues', '39 av Jean Perrot', '93000', 'BAGNOLET', '19980618'),
('k4', 'Lanne', 'Bernard', '4 r Bayeux', '30000', 'NIMES', '19961121'),
('k53', 'Le', 'Noël', '4 av Beauvert', '68000', 'MULHOUSE', '19830323'),
('l14', 'Le', 'Jean', '39 r Raspail', '53000', 'LAVAL', '19950202'),
('l23', 'Leclercq', 'Servane', '11 r Quinconce', '18000', 'BOURGES', '19950605'),
('l46', 'Lecornu', 'Jean-Bernard', '4 bd Mar Foch', '72000', 'LA FERTE BERNARD', '19970124'),
('l56', 'Lecornu', 'Ludovic', '4 r Abel Servien', '25000', 'BESANCON', '19960227'),
('m35', 'Lejard', 'Agnès', '4 r Anthoard', '82000', 'MONTAUBAN', '19871006'),
('m45', 'Lesaulnier', 'Pascal', '47 r Thiers', '57000', 'METZ', '19901013'),
('n42', 'Letessier', 'Stéphane', '5 chem Capuche', '27000', 'EVREUX', '19960306'),
('n58', 'Loirat', 'Didier', 'Les Pêchers cité Bourg la Croix', '45000', 'ORLEANS', '19920830'),
('n59', 'Maffezzoli', 'Thibaud', '5 r Chateaubriand', '2000', 'LAON', '19941219'),
('o26', 'Mancini', 'Anne', '5 r D''Agier', '48000', 'MENDE', '19950105'),
('p32', 'Marcouiller', 'Gérard', '7 pl St Gilles', '91000', 'ISSY LES MOULINEAUX', '19921224'),
('p40', 'Michel', 'Jean-Claude', '5 r Gabriel Péri', '61000', 'FLERS', '19921214'),
('p41', 'Montecot', 'Françoise', '6 r Paul Valéry', '17000', 'SAINTES', '19980727'),
('p42', 'Notini', 'Veronique', '5 r Lieut Chabal', '60000', 'BEAUVAIS', '19941212'),
('p49', 'Onfroy', 'Den', '5 r Sidonie Jacolin', '37000', 'TOURS', '19771003'),
('p6', 'Pascreau', 'Charles', '57 bd Mar Foch', '64000', 'PAU', '19970330'),
('p7', 'Pernot', 'Claude-Noël', '6 r Alexandre 1 de Yougoslavie', '11000', 'NARBONNE', '19900301'),
('p8', 'Perrier', 'Maître', '6 r Aubert Dubayet', '71000', 'CHALON SUR SAONE', '19910623'),
('q17', 'Petit', 'Jean-Louis', '7 r Ernest Renan', '50000', 'SAINT LO', '19970906'),
('r24', 'Piquery', 'Patrick', '9 r Vaucelles', '14000', 'CAEN', '19840729'),
('r58', 'Quiquandon', 'Joël', '7 r Ernest Renan', '29000', 'QUIMPER', '19900630'),
('s10', 'Retailleau', 'Josselin', '88Bis r Saumuroise', '39000', 'DOLE', '19951114'),
('s21', 'Retailleau', 'Pascal', '32 bd Ayrault', '23000', 'MONTLUCON', '19920925'),
('t43', 'Souron', 'Maryse', '7B r Gay Lussac', '21000', 'DIJON', '19950309'),
('t47', 'Tiphagne', 'Patrick', '7B r Gay Lussac', '62000', 'ARRAS', '19970829'),
('t55', 'Tréhet', 'Alain', '7D chem Barral', '12000', 'RODEZ', '19941129'),
('t60', 'Tusseau', 'Josselin', '63 r Bon Repos', '28000', 'CHARTRES', '19910329'),
('zzz', 'swiss', 'bourdin', NULL, NULL, NULL, '20030618');
...
CREATE TABLE dbo.rapportvisite (
...
INSERT INTO dbo.rapportvisite (RAP_NUM, RAP_DATE, RAP_BILAN, RAP_MOTIF, PRA_NUM, VIS_MATRICULE) VALUES
('10', '20051212', 'Diversification activité, nouveaux secteurs explorés', 'Actualisation annuelle', 33, 'a17'),
('15', '20170927', 'En cours de spécialisation sur les produits pour la prise en charge des douleurs post-opératoires', 'Reactualisation', 17, 'zzz'),
('25', '20090217', 'Nouveau cabinet médical', 'Prise de contact', 42, 'b28'),
('3', '20020418', 'Médecin curieux, à recontacter en décembre pour réunion', 'Actualisation annuelle', 23, 'a131'),
('4', '20030521', 'Changement de direction, redéfinition de la politique médicamenteuse, recours au générique', 'Baisse activité', 4, 'a17'),
('7', '20030323', 'RAS\r Changement de tel : 05 89 89 89 89', 'Rapport Annuel', 41, 'a131');
...
CREATE TABLE dbo.presenter (
  RAP_NUM VARCHAR(255) NOT NULL,
  MED_DEPOTLEGAL VARCHAR(255) NOT NULL,
  Nombre_Echantillon INT DEFAULT NULL,
...
INSERT INTO dbo.presenter (RAP_NUM, MED_DEPOTLEGAL, Nombre_Echantillon) VALUES
('10', '3MYC7', 10),
('10', 'AMOX45', 10),
('15', 'DOLRIL7', 5),
('4', '3MYC7', 3),
